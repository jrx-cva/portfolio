...
public class ProfesorDao {
    ...
    public void anadirProfesor(String nif, String especialidad, String nombre, String telefono) {
        try {
    ...
    public void anadirAsignatura(String codasignatura, String nombre, int idprofesor) {
        try {
