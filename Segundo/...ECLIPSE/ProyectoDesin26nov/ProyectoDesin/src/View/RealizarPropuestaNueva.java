		...
		btnRealizarPropuesta.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(!(tfPrecioRealizarPropuesta.getText().equals(null)) && !(tfNombreYApellidosRealizarPropuesta.getText().equals(null))) {
					...
					registrarPropuesta.registrarPropuesta(tfNombreYApellidosRealizarPropuesta.getText(), tfDescripcinVehiculoRealizarPropuesta.getText(), tfPrecioRealizarPropuesta.getText().toString(), tfFechaRealizarPropuesta.getText().toString(), tfDescripcinVehiculoRealizarPropuesta.getText());
				}
				okPropuesta();
