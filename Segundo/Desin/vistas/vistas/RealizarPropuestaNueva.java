		...
		btnRealizarPropuesta.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(!(tfPrecioRealizarPropuesta.getText().equals(null)) && !(tfNombreYApellidosRealizarPropuesta.getText().equals(null))) {
					...
					registrarPropuesta.registrarPropuesta(null, tfNombreYApellidosRealizarPropuesta.getText().toString(), tfDescripcinVehiculoRealizarPropuesta.getText(), tfPrecioRealizarPropuesta.getText().toString(), tfFechaRealizarPropuesta.getText().toString(), null, tfDescripcinVehiculoRealizarPropuesta.getText());
				}
				okPropuesta();
