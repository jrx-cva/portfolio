CREATE DATABASE  IF NOT EXISTS `bd_neptuno` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `bd_neptuno`;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `Iniciales_Empleado`(var_id int(11)) RETURNS varchar(40) CHARSET utf8
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `Prefijo`(cadena varchar(15), num_char int) RETURNS varchar(15) CHARSET utf8
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `tipo_de_via`(direccion varchar(50)) RETURNS varchar(10) CHARSET utf8
    DETERMINISTIC
begin
